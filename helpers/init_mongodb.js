...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/TICKET'; // Default connection string
const DB_NAME = process.env.DB_NAME || 'TICKET'; // Default database name
